...
void main() {
  ...
  testWidgets('simple_timer', (WidgetTester tester) async {
    ...
    await pumpUntilGone(
        ...
        screenShotName: '13_simple-timer_rest-interval-1');
    ...
    await pumpUntilFound(
        ...
        screenShotName: '14_simple-timer_work-interval-2');
    // Make sure the Nice job! screen is shown.
    await pumpForDuration(tester, Duration(seconds: 10),
        screenShotName: '15_simple-timer_running-interval-2', settle: false);
    // Exit the timer.
    await tapButtonByKey(
        tester, 'timer-end-back', '16_simple-timer_end-back', binding, false);
    // ---
  });
}
