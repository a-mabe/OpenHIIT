...
void main() {
  testWidgets('Test CreateWorkout', (WidgetTester tester) async {
    ...
    await createOrEditWorkout(tester, workoutName, 3, true, "Long whistle",
        "Ding", "Quick beep sequence", "Beep", "Horn", "60", "30");
    ...
    await createOrEditWorkout(tester, workoutName, 2, false, "Ding",
